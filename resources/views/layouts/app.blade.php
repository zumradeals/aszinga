...
<header class="sticky top-0 z-50 border-b border-black/10 bg-white/95 shadow-sm backdrop-blur">
    <div class="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-3 lg:px-8">
        <a href="{{ route('home') }}" class="flex min-w-0 items-center gap-3"><div class="grid size-12 shrink-0 place-items-center overflow-hidden rounded-xl bg-zinc-950"><img src="{{ asset('images/as-zinga-logo.png') }}" alt="Logo officiel A.S ZINGA" class="h-full w-full object-contain p-1" onerror="this.style.display='none';this.nextElementSibling.style.display='grid'"><span class="hidden h-full w-full place-items-center font-black text-orange-500">ASZ</span></div><div class="min-w-0"><strong class="block truncate text-base leading-none">A.S ZINGA</strong><span class="mt-1 block truncate text-[11px] font-semibold uppercase tracking-wider text-zinc-500">Abobo • Abidjan</span></div></a>
...
<footer class="bg-zinc-950 text-white">
 <div class="mx-auto max-w-7xl px-4 py-16 lg:px-8">
  <div class="grid gap-12 border-b border-white/10 pb-12 md:grid-cols-2 lg:grid-cols-4">
   <div><div class="flex items-center gap-3"><div class="grid size-16 place-items-center overflow-hidden rounded-xl bg-black/30"><img src="{{ asset('images/as-zinga-logo.png') }}" alt="Logo officiel A.S ZINGA" class="h-full w-full object-contain p-1" onerror="this.style.display='none';this.nextElementSibling.style.display='grid'"><span class="hidden h-full w-full place-items-center font-black text-orange-500">ASZ</span></div><div><strong class="text-xl">A.S ZINGA</strong><p class="text-xs uppercase tracking-wider text-zinc-500">Association Sportive</p></div></div><p class="mt-5 max-w-xs text-sm leading-6 text-zinc-400">La passion du football, l’avenir de nos jeunes. Un club enraciné à Abobo et tourné vers la formation, la discipline et l’ambition.</p></div>
