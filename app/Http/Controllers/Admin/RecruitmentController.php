...
class RecruitmentController extends Controller
{
    ...
    public function update(Request $request, RecruitmentApplication $recruitment){ $data=$request->validate(['status'=>'required|in:nouvelle,en_etude,contactee,acceptee,refusee','admin_notes'=>'nullable|string|max:5000']); $recruitment->update($data); return redirect()->route('admin.recruitment.index')->with('success','Candidature mise à jour.'); }
